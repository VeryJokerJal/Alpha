...
namespace UIShell.Controls
{
    ...
    public sealed class WindowSystemButton : ButtonBase
    {
        ...
        DependencyProperty.Register(nameof(WinSysType), typeof(WinSysType), typeof(WindowSystemButton), new FrameworkPropertyMetadata(WinSysType.Minimize, OnWinSysTypeChanged));

        internal static readonly DependencyProperty CurrentWinSysTypeProperty =
        DependencyProperty.Register(nameof(CurrentWinSysType), typeof(CurrentWinSysType), typeof(WindowSystemButton), new FrameworkPropertyMetadata(CurrentWinSysType.Minimize));
